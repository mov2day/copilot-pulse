...
export interface AllowanceSnapshot { amount: number; consumed?: number; remaining?: number; unlimited?: boolean; plan?: string; resetsAt?: string; observedAt: string; sourceId: string; quality: DataQuality; }
